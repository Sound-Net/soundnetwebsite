...
Go back to SoundTrapHost software with the SoundTrap attached and look at the file list. Do any of the files say *partial* instead of *downloaded*? Or do any of the files show as simply not downloaded? If so, these files need to be downloaded again.
...
If a sensor package did not work, or you suspect it might be damaged, the easiest way to check is with SoundNet Sensor Viewer
...
- for OkB `.sud` files -- download them again and repeat. 
