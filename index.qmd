...
::: {.tool-buttons}
[Download for macOS](https://github.com/Sound-Net/sensorfirmwareupdater/releases/latest/download/sensorfirmwareupdater-macos.dmg){.btn .btn-primary download=""}
[Download for Windows](https://github.com/Sound-Net/sensorfirmwareupdater/releases/latest/download/sensorfirmwareupdater-windows.exe){.btn .btn-outline-primary download=""}
:::
:::
